...
describe('CommHeatmap', () => {
  ...
  it('renders column headers for every agent', () => {
    ...
    expect(screen.getAllByText('Lead lead1').length).toBeGreaterThanOrEqual(1);
    expect(screen.getAllByText('Developer dev1').length).toBeGreaterThanOrEqual(1);
    expect(screen.getAllByText('Reviewer rev1').length).toBeGreaterThanOrEqual(1);
  });
  ...
  it('shows tooltip with correct from/to/count on mouse enter', () => {
    ...
    expect(tooltip!.textContent).toContain('Lead lead1');
    expect(tooltip!.textContent).toContain('Developer dev1');
